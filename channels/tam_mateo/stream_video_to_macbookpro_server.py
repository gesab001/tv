...
for filename in jsonfiles:
  ...
  try:
    ...
    #if proceed=="y":
    #command = 'ffmpeg -re -i ' +  '"'+url+'"' + ' -vcodec libx264 -vprofile baseline -g 30 -acodec aac -strict -2  -preset fast -b:v 5M -maxrate 6M -bufsize 3M -threads 4 -f flv rtmp://192.168.1.15:1935/show/stream'
...
command = "ffmpeg -re -f concat -safe 0 -i playlist.txt -r 30 -c:v libx264 -x264-params keyint=60:scenecut=0 -preset fast -b:v 5M -maxrate 6M -bufsize 3M -threads 4 -f flv rtmp://192.168.1.15:1935/show/stream"
